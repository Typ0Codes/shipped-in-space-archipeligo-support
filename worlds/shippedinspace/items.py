...
DEFAULT_ITEM_CLASSIFICATIONS = {
    "HealthPack": ItemClassification.filler,
    "AmmoBox": ItemClassification.filler,  # Items can have multiple classifications.
...
def get_random_filler_item_name(world: ShippedInSpaceWorld) -> str:
    # ShippedInSpace has an option called "trap_chance".
    ...
    if world.random.randint(0, 2) == 1:
        return "HealthPack"
    elif world.random.randint(0, 2) == 2:
        return "Shield"
    else:
        return "AmmoBox"
...
def create_item_with_correct_classification(world: ShippedInSpaceWorld, name: str) -> ShippedInSpaceItem:
    ...
    return ShippedInSpaceItem(name, classification, ITEM_NAME_TO_ID[name], world.player)


# With those two helper functions defined, let's now get to actually creating and submitting our itempool.
def create_all_items(world: ShippedInSpaceWorld) -> None:
    ...
    # ShippedInSpace has two of these: The Confetti Cannon and the Math Trap.
    ...
    #  Starting here, the word "filler" will be used to collectively refer to ShippedInSpace's Confetti Cannon and Math Trap,
    ...
    # But there is an alternative that works even better for most worlds, including ShippedInSpace.
    ...
    # ShippedInSpace is one of these games:

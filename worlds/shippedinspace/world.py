...
# ShippedInSpace will go through all the parts of the world api one step at a time,
...
class ShippedInSpaceWorld(World):
    ...
    web = web_world.ShippedInSpaceWebWorld()

    # This is how we associate the options defined in our options.py with our world.
    options_dataclass = options.ShippedInSpaceOptions
    options: options.ShippedInSpaceOptions  # Common mistake: This has to be a colon (:), not an equals sign (=).
    ...
    def create_item(self, name: str) -> items.ShippedInSpaceItem:
